...
public class UniverseRepository implements IUniverseRepository {           //som implementerer interfacet
    ...
    @Override
    public void UpdatePlanet(String noe,String name, String mass, String radius, String semiMajorAxis, String eccen, String orbitalP, String pictureurl) {

    }

    @Override
    public void DeletePlanet(String noe,String planetnavn) {
