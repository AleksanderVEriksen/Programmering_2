...
public String getPlanetWithName(String planetNavn){
        String s = "Planeten finnes ikke";                                       //String Argument
        for(Planet planet : planets){
           // System.out.println("X: " + x + ", Planet name: " + planet.name);   //Går gjennom planet arrayet der alle planetene er lagret
            if(planetNavn.equals(planet.name)){                                  // Sjekker om Stringen er lik navnet på planetene i Array listen

                return planet.toString();                                         // Returnere planeten med det navnet og bruker toString() metoden for å få mer informasjon
            }
        }
        return s;                                                          //Om Stringen ikke er lik navnene i Array listen, så returnerer String s="Planeten finnes ikke"
}
